...
public class MasterListAdapter extends BaseAdapter {
    ...
    public MasterListAdapter(Context context, int mResId, List<ListRowItems> mRowItem) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.txtLife = (TextView) view.findViewById(R.id.list_Desc);
            holder.txtName = (TextView) view.findViewById(R.id.list_Title);
            ...
            holder.txtLife.setOnClickListener(mItemListener);
            holder.txtName.setOnClickListener(mItemListener);
        ...
        holder.txtLife.setText(rowItem.getDescription());
    ...
    private View.OnClickListener mItemListener = new View.OnClickListener() {
        public void onClick(View v) {
            IListSelection iList = new QuotesListSelection(mContext,1,v);
            switch (v.getId()) {
                case R.id.list_Desc:
